...
export function CompliancePolicyPage() {
  return (
    <PolicyPageShell title="KYC/KYB and AML Policy">
      ...
      <section>
        <h2 className="text-2xl font-semibold text-gray-900 mb-4">2. Know Your Customer and Know Your Business</h2>
      ...
      <section>
        <h2 className="text-2xl font-semibold text-gray-900 mb-4">3. Supported Jurisdictions</h2>
        <p className="text-gray-700 leading-relaxed mb-4">
        ...
        <h3 className="text-lg font-semibold text-gray-900 mb-2">Eligibility principles</h3>
        ...
        <h3 className="text-lg font-semibold text-gray-900 mb-2">Prohibited jurisdictions</h3>
        ...
        <h3 className="text-lg font-semibold text-gray-900 mb-2">Controlled jurisdictions</h3>
        <p className="text-gray-700 leading-relaxed mb-2">
        ...
        />
        <h3 className="text-lg font-semibold text-gray-900 mb-2">Other jurisdictions</h3>
        <p className="text-gray-700 leading-relaxed">
      ...
      <section>
        <h2 className="text-2xl font-semibold text-gray-900 mb-4">4. When We Verify</h2>
        <p className="text-gray-700 leading-relaxed mb-4">We conduct KYC/KYB when:</p>
      ...
      <section>
        <h2 className="text-2xl font-semibold text-gray-900 mb-4">5. Information We Collect</h2>
        <h3 className="text-lg font-semibold text-gray-900 mb-2">Annex A — Individual users (Easner Personal)</h3>
        <ul className="list-disc pl-6 space-y-2 text-gray-700 mb-4">
        ...
        <h3 className="text-lg font-semibold text-gray-900 mb-2">Annex B — Business users (Easner Business)</h3>
        <ul className="list-disc pl-6 space-y-2 text-gray-700 mb-4">
        ...
        <h3 className="text-lg font-semibold text-gray-900 mb-2">Document standards</h3>
        <p className="text-gray-700 leading-relaxed">
      ...
      <section>
        <h2 className="text-2xl font-semibold text-gray-900 mb-4">7. Our AML Program</h2>
        <p className="text-gray-700 leading-relaxed mb-4">Easner&apos;s AML framework includes:</p>
        <ul className="list-disc pl-6 space-y-2 text-gray-700 mb-4">
          <li>
        ...
        <h3 className="text-lg font-semibold text-gray-900 mb-2">Suspicious activity reporting</h3>
        <p className="text-gray-700 leading-relaxed">
      ...
      <section>
        <h2 className="text-2xl font-semibold text-gray-900 mb-4">8. Tier Entitlements</h2>
        <PolicyTable
      ...
      <section>
        <h2 className="text-2xl font-semibold text-gray-900 mb-4">9. Verification Outcomes and Limits</h2>
        <p className="text-gray-700 leading-relaxed mb-2">
      ...
      <section>
        <h2 className="text-2xl font-semibold text-gray-900 mb-4">10. Your Responsibilities</h2>
      ...
      <section>
        <h2 className="text-2xl font-semibold text-gray-900 mb-4">12. Sharing and Security</h2>
        <p className="text-gray-700 leading-relaxed">
