...
export function TermsPolicyPage() {
  return (
    <PolicyPageShell title="Terms of Service">
      ...
      <section>
        <h2 className="text-2xl font-semibold text-gray-900 mb-4">2. Electronic Communications and E-Sign</h2>
        <p className="text-gray-700 leading-relaxed mb-4">
      ...
      <section>
        <h2 className="text-2xl font-semibold text-gray-900 mb-4">3. About Easner</h2>
        <p className="text-gray-700 leading-relaxed mb-4">
      ...
      <section>
        <h2 className="text-2xl font-semibold text-gray-900 mb-4">4. The Services</h2>
        <h3 className="text-lg font-semibold text-gray-900 mb-2">Easner Personal</h3>
        <p className="text-gray-700 leading-relaxed mb-4">
        ...
        <h3 className="text-lg font-semibold text-gray-900 mb-2">Easner Business</h3>
        <p className="text-gray-700 leading-relaxed mb-4">
        ...
        <h3 className="text-lg font-semibold text-gray-900 mb-2">Partner-provided financial services</h3>
        <p className="text-gray-700 leading-relaxed mb-4">
        ...
        <h3 className="text-lg font-semibold text-gray-900 mb-2">Digital asset and wallet services</h3>
        <p className="text-gray-700 leading-relaxed mb-4">
      ...
      <section>
        <h2 className="text-2xl font-semibold text-gray-900 mb-4">5. Eligibility</h2>
        <p className="text-gray-700 leading-relaxed mb-4">To use the Services you must:</p>
        <ul className="list-disc pl-6 space-y-2 text-gray-700 mb-4">
      ...
      <section>
        <h2 className="text-2xl font-semibold text-gray-900 mb-4">7. Fees and Exchange Rates</h2>
        <p className="text-gray-700 leading-relaxed mb-4">
      ...
      <section>
        <h2 className="text-2xl font-semibold text-gray-900 mb-4">8. Payments, Settlement, and Reversals</h2>
        <p className="text-gray-700 leading-relaxed mb-4">
      ...
      <section>
        <h2 className="text-2xl font-semibold text-gray-900 mb-4">9. Compliance, Limits, and Holds</h2>
        <p className="text-gray-700 leading-relaxed mb-4">
      ...
      <section>
        <h2 className="text-2xl font-semibold text-gray-900 mb-4">10. Availability</h2>
        <p className="text-gray-700 leading-relaxed">
      ...
      <section>
        <h2 className="text-2xl font-semibold text-gray-900 mb-4">12. Prohibited Use</h2>
        <p className="text-gray-700 leading-relaxed">
      ...
      <section>
        <h2 className="text-2xl font-semibold text-gray-900 mb-4">16. Changes</h2>
        <p className="text-gray-700 leading-relaxed">
      ...
      <section>
        <h2 className="text-2xl font-semibold text-gray-900 mb-4">17. Governing Law and Disputes</h2>
        <p className="text-gray-700 leading-relaxed mb-4">
      ...
      <section>
        <h2 className="text-2xl font-semibold text-gray-900 mb-4">18. General Provisions</h2>
        <p className="text-gray-700 leading-relaxed mb-4">
