        ...
        <div className="py-6 sm:py-8">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 mb-4">
            ...
            <div className="flex flex-wrap items-center justify-center sm:justify-end gap-x-6 gap-y-2 sm:space-x-0">
              <Link href="/terms" className="text-xs sm:text-sm text-gray-500 hover:text-easner-primary transition-colors">Terms of Service</Link>
              ...
              <Link href="/compliance" className="text-xs sm:text-sm text-gray-500 hover:text-easner-primary transition-colors">Compliance</Link>
            </div>
          </div>
          <div className="text-center sm:text-left text-xs sm:text-sm text-gray-500 mb-4">
            <p>
              ...
              {" "}or{" "}
              <a href="mailto:legal@easner.com" className="text-easner-primary hover:underline">legal@easner.com</a>
          ...
          <div className="pt-4 border-t border-gray-200">
            <div className="text-xs text-gray-400 text-center sm:text-left max-w-4xl mx-auto space-y-3 leading-relaxed">
              ...
              <p>
                ...
                <Link href="/terms" className="text-easner-primary hover:underline">Terms of Service</Link>
                ,{" "}
                <Link href="/privacy" className="text-easner-primary hover:underline">Privacy Policy</Link>
                , and{" "}
                <Link href="/compliance" className="text-easner-primary hover:underline">KYC/KYB and AML Policy</Link>
