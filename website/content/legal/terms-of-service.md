...
**Service tiers (availability depends on verification, jurisdiction, and partner enablement):**
...
**Important:** Easner is a **financial technology company, not a bank**. Banking, money transmission, payment acceptance, verification, and card services made available through the Services are provided by **licensed financial partners** in their respective jurisdictions. Easner does not offer FDIC or equivalent deposit insurance and does not itself hold customer deposits. Partner disclosures presented during onboarding, in receipts, or in these Terms identify the regulated provider for the relevant service.
...
Identity verification, virtual accounts, fiat pay-in and pay-out, money transmission, card acceptance, sanctions screening, and related compliance processing are delivered by **licensed partners**. Easner provides the technology interface and program management.

When you use partner-provided services, you may need to accept **separate partner terms and privacy notices** in the onboarding flow (or via these Terms). Those terms govern the regulated services the partner provides and are incorporated by reference to the extent they apply to your use through Easner. Our **Privacy Policy** identifies key financial and infrastructure partners.
...
**Stripe.** When you enable **online payments** / Stripe Connect for invoice card acceptance, Stripe’s Connected Account Agreement, Stripe Services Agreement, and related Stripe terms apply to card acceptance and settlement, in addition to these Terms.
...
- You will only charge for legitimate goods or services you are authorized to sell
- You will comply with card-network rules, Stripe’s prohibited and restricted business lists, and applicable consumer and tax law
- You are responsible for refunds, disputes, and **chargebacks** related to your invoice payments, including any amounts Stripe or Easner debits or reserves from your balances
...
### Self-custody wallets and flow of funds

For Turnkey-backed wallet features, **Easner does not sit in the flow of funds** as a custodian or signing party. Specifically:

- We do not sign or co-sign user transactions.
- We do not hold, custody, or export users’ private keys or seed phrases.
- Wallet keys and signing are managed within **Turnkey’s** secure infrastructure, not by Easner – Turnkey governs key generation and transaction signing.
...
When Tier 2 cards are offered, they will be issued or facilitated by a **licensed card program partner** under a separate cardholder or program agreement, subject to partner underwriting and jurisdiction. Until launch, any cards screens in the Services are informational only.
...
- Not be in a **prohibited or controlled** jurisdiction, comprehensively sanctioned territory, or any location where use of the Services is unlawful
...
- Use the Services lawfully and in line with AML, sanctions, tax, employment, and consumer-protection obligations
- Protect passwords, PINs, and authentication factors
- Notify us promptly of unauthorized access or suspected fraud
- Ensure payouts, invoices, payroll, online payments, and collections reflect legitimate activity

**Business users** must maintain accurate ownership and signatory information, control team access, and use collections, payroll, and online-payment features in compliance with applicable law (including card-network and Stripe rules where enabled).
...
**Fees, charges, and exchange rates may apply** depending on product, corridor, currency pair, payment method, and partner costs (including Stripe processing fees for online payments and partner corridor fees). Applicable fees and rates are **shown before you confirm** a transaction or enable a feature unless otherwise required by law.
...
**Refunds and reversals** are provided only where required by law, partner rules, card-network rules, or Easner policy. They are not guaranteed.

**Chargebacks and payment disputes** initiated with a cardholder’s bank, Stripe, or another payment provider regarding invoice payments, funded payments, or collections may result in account holds, debits from your Easner or Stripe balances, reserves, suspension, or closure.
...
Our **Privacy Policy** describes how we collect, use, and protect personal information. By using the Services, you consent to those practices and to processing required by partners for compliance and payment acceptance.
...
**Force majeure:** Easner is not liable for delays or failures caused by events beyond our reasonable control, including partner outages, banking hours, card-network outages, network or blockchain failures, acts of government, or regulatory action.
...
1.4 E-Sign Consent and Communications. By accepting these Terms, you consent to receive all communications, agreements, notices, disclosures, and other documents from Lightspark electronically, including by email, through the Platform’s interface, or by text message (each an “Electronic Communication”). You agree that all such Electronic Communications satisfy any legal requirement that such communications be in writing. You have the right to have these communications provided to you in paper form instead of electronically. To request a paper copy of any communication, contact us at support@lightsparkpayments.com; we may charge a fee for paper copies as described in that response. Your consent applies to all communications, agreements, notices, and disclosures related to your use of the Grid Transaction Services for as long as you maintain an account with us, unless and until you withdraw consent as described below. To access, view, and retain Electronic Communications, you will need: (i) An up-to-date device or devices (e.g., computer, tablet, mobile phone, etc.) that has internet access; (ii) a current, compatible web browser, including Chrome (versions greater than 49), Internet Explorer 11, the last two versions of Firefox, Safari and Edge, or the last two versions of mobile Safari on iOS; (iii) A valid email account and access to that email account; (iv) An operating system capable of receiving, accessing and displaying records and Electronic Communications from us in electronic form via text-formatted email or access to our website using a supported browser, including any necessary software (e.g., Adobe to read pdf documents); and (v) If you wish to store or print any Electronic Communications, a device capable of storing and printing Electronic Communications. If our hardware or software requirements change in a way that creates a material risk you will not be able to access or retain future Electronic Communications, we will notify you and, where required by law, obtain your renewed consent. You may withdraw your consent to receive Electronic Communications at any time by contacting us at support@lightsparkpayments.com. When you contact us to withdraw consent, please include your name and the email address or phone number associated with your account. You may also update the contact information we use to reach you electronically at any time by contacting support. If you withdraw your consent to Electronic Communications, we may suspend or terminate your access to the Grid Transaction Services, since electronic delivery is necessary for us to provide those services.

1.5 Telephone and Text Message Consent. You consent to receive telephone calls, text messages (including SMS and MMS), and other communications from Lightspark at the telephone number(s) you provide to us, including through the use of autodialed or prerecorded calls and messages, for non-marketing purposes related to your use of the Grid Transaction Services, including identity verification, fraud alerts, and account notifications. Message and data rates may apply, and message frequency may vary. You may withdraw this consent at any time by replying STOP to any text message or by contacting us at support@lightsparkpayments.com. Because these communications are used to verify your identity and keep your account secure, if you withdraw this consent, Lightspark may be unable to continue providing the Grid Transaction Services to you and may suspend or close your account.

1.6 Restricted Locations. The Grid Transaction Services are not available in all countries, states, or jurisdictions. Lightspark may, in its sole discretion, restrict or prohibit access to the Grid Transaction Services from certain locations (each, a “Restricted Location”), including locations where Lightspark does not hold the required licenses or registrations to provide the Grid Transaction Services, or where providing the Grid Transaction Services would violate Applicable Law. A current list of Restricted Locations is maintained in the Documentation and may be updated by Lightspark at any time without prior notice. You may not access or use the Grid Transaction Services if you are located in, organized in, or a resident of a Restricted Location. Restricted Locations are in addition to, and not a substitute for, the Sanctioned Country restrictions set forth in Section 10.

## 2. Onboarding and Verification.

2.1 Know-Your-Customer and Know-Your-Business. To help the government fight the funding of terrorism and money laundering activities, Federal law requires all financial institutions to obtain, verify, and record information that identifies each person who opens an account. Before you may access or use the Grid Transaction Services, you must complete Lightspark’s identity verification process, which may include know-your-customer (“KYC”) or know-your-business (“KYB”) procedures, as applicable. You agree to provide accurate, current, and complete information during the onboarding process, and to promptly update such information if it changes. Lightspark may, at any time during the term of your use of the Grid Transaction Services, request additional information or documentation to verify your identity, the identity of your beneficial owners, or the nature of your business. You authorize Lightspark to make inquiries, directly or through third parties, that Lightspark considers necessary to verify your identity or protect you and/or Lightspark against fraud, money laundering, terrorist financing, or other financial crimes, and to take any action Lightspark reasonably deems necessary based on the results of such inquiries. Depending on your jurisdiction, the identity verification process may require you to provide a government-issued identification document, proof of address, tax identification number (such as a Social Security Number, Individual Taxpayer Identification Number, Employer Identification Number, or foreign equivalent), proof of business registration, information about beneficial owners, or other documentation as required by Applicable Law or Lightspark’s compliance program.
...
5.4 ACH Authorization. If you connect a bank account as an External Account, you authorize Lightspark, its Grid Switch Partners, and Lightspark’s Originating Depository Financial Institution (the “ODFI”) to originate ACH credit and debit entries to and from your designated bank account in connection with Grid Transactions and the funding and withdrawal of your Internal Account. This authorization includes, without limitation: (a) credits (deposits) to your bank account for payouts, withdrawals, refunds, and error corrections; (b) debits (charges) from your bank account for funding your Internal Account, fee payments, error corrections, and recovery of amounts owed to Lightspark; and (c) reversals, corrections, and adjustments as may be necessary to correct erroneous entries or to comply with Applicable Law or the rules of the National Automated Clearing House Association (“NACHA”). This authorization will remain in full force and effect until: (x) your account is closed and all outstanding obligations are satisfied; (y) you revoke this authorization by providing written notice to Lightspark at support@lightsparkpayments.com, provided that any such revocation will not affect any ACH entry processed before Lightspark has had a reasonable opportunity to act on such revocation (which shall be no less than three (3) Business Days (each, a “Business Day,” meaning any day other than Saturday, Sunday, or a federal holiday in the United States)); and (z) all amounts owed by you to Lightspark are paid in full. You agree to comply with, and to be bound by, the NACHA Operating Rules applicable to you, as amended from time to time, to the same extent as if you were a party thereto, with respect to any ACH Entry you originate or authorize through the Grid Transaction Services. You agree that you will not originate or authorize any ACH Entry that violates the laws of the United States, including the economic sanctions programs administered by OFAC. You agree not to dispute any ACH debit entry initiated by Lightspark in accordance with these Terms, except as provided in the Error Resolution procedures set forth in Exhibit A. You may originate or authorize only those types of ACH Entries, using only the Standard Entry Class Codes, that Lightspark makes available for your account type as described in the Documentation. Lightspark may add, restrict, or remove permitted Entry types or Standard Entry Class Codes at any time. You shall not originate or authorize any Entry for a purpose prohibited by Section 9 or otherwise not permitted under these Terms. You acknowledge and agree that Lightspark’s ODFI has the right to terminate or suspend your ability to originate ACH Entries, or to require Lightspark to do so, for your breach of the NACHA Operating Rules, in a manner that permits the ODFI to comply with the NACHA Operating Rules. Lightspark may act upon any such direction immediately and without prior notice where required for the ODFI’s compliance. If you are a Business End User, you agree that Lightspark and its ODFI have the right, upon reasonable prior written notice (or without notice where fraud or a material breach is suspected), to audit your compliance with these Terms and the NACHA Operating Rules as they relate to ACH Entries you originate or authorize, and you will reasonably cooperate with, and promptly provide records requested in connection with, any such audit.
