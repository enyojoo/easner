...
export default function AdminRatesPage() {
  ...
  const handleRateUpdate = (currency: string, value: number) => {
    setRates((prev) => ({
      ...prev,
      [currency]: value,
    }))
        ...
        <div className="p-6 space-y-6">
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <label className="font-medium">USD to NGN</label>
                  <div className="flex items-center space-x-2">
                    <Input
                      type="number"
                      value={rates.usd_to_ngn}
                      onChange={(e) => handleRateUpdate("usd_to_ngn", Number(e.target.value))}
                      className="w-32"
                    />
                ...
                <div className="flex items-center justify-between">
                  <label className="font-medium">GBP to NGN</label>
                  <div className="flex items-center space-x-2">
                    <Input
                      type="number"
                      value={rates.gbp_to_ngn}
                      onChange={(e) => handleRateUpdate("gbp_to_ngn", Number(e.target.value))}
                      className="w-32"
                    />
                    <Button size="sm">Update</Button>
                  </div>
                ...
                <div className="flex items-center justify-between">
                  <label className="font-medium">EUR to NGN</label>
                  <div className="flex items-center space-x-2">
                    <Input
                      type="number"
                      value={rates.eur_to_ngn}
                      onChange={(e) => handleRateUpdate("eur_to_ngn", Number(e.target.value))}
                      className="w-32"
                    />
                    <Button size="sm">Update</Button>
                  </div>
